...
public class SignInActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //BEGIN CUT PASTE FROM MAINACTIVITY.ONCREATE
        ...
        //END CUT PASTE FROM MAINACTIVITY.ONCREATE
...
//            Intent intent = new Intent(this, MainActivity.class);
    ...
    //BEGIN CUT PASTE FROM MainActivity
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.ACCESS_COARSE_LOCATION)){
            ...
            builder.setOnDismissListener(new DialogInterface.OnDismissListener() {
                public void onDismiss(DialogInterface dialog) {
                    ...
                    ActivityCompat.requestPermissions(SignInActivity.this, new String[]{android.Manifest.permission.ACCESS_COARSE_LOCATION}, REQUEST_LOCATION);
                }
            });
            builder.show();
        } else {
    ...
    private void showMsg(String msg) {
        ...
        ((TextView) SignInActivity.this.findViewById(R.id.detail)).setText(msg);
    }
    ...
    private class ListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = SignInActivity.this.getLayoutInflater().inflate(
